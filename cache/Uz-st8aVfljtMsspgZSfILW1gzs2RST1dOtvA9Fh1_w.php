...
// PUG_DEBUG:8
 ?><?php if (method_exists($_pug_temp = (isset($mode) ? $mode : null) != 'dev', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php 
...
// PUG_DEBUG:9
 }  $attach = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'attach') ?><?php 
...
// PUG_DEBUG:224
 ?><?php $glo = array( 'attach' => $attach ) ?><?php 
