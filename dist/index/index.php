...
$__pug_mixins['header'] = function ($block, $attributes, $__pug_arguments, $__pug_mixin_vars, $__pug_children) use (&$__pug_mixins, &$pugModule) {
    ...
    ?><div<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment']($attributes, ['class' => 'header'], ['class' => 'row'], ['class' => 'jcsb'], ['class' => 'p1o25'])) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php if (method_exists($_pug_temp = (isset($mode) ? $mode : null) != 'dev', "__toBoolean")
        ? $_pug_temp->__toBoolean()
        : $_pug_temp) { ?><?php global $glo; ?><?php null ?><?php } $attach = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($glo, 'attach') ?><?php if (!isset($__pug_mixins)) {
    $__pug_mixins = [];
}
$__pug_mixin_vars = [];
...
$__pug_mixins['card-shop'] = function ($block, $attributes, $__pug_arguments, $__pug_mixin_vars, $__pug_children) use (&$__pug_mixins, &$pugModule) {
    ...
    if (method_exists($_pug_temp = (isset($mode) ? $mode : null) != 'dev', "__toBoolean")
        ? $_pug_temp->__toBoolean()
